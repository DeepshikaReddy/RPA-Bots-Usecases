## This project contains step by step procedure to generate a voucher with random number generation and calculate issue date and expiry date and email the Excel to the RM manager.
